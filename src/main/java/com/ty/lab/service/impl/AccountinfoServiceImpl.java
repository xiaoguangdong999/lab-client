...
public class AccountinfoServiceImpl implements AccountinfoService {
    ...
    @Override
    public List<TbAccountinfo> findAllByExample(TbAccountinfo accountinfo) {
        TbAccountinfoExample example = new TbAccountinfoExample();
        TbAccountinfoExample.Criteria criteria = example.createCriteria();
        ...
        List<TbAccountinfo> tbAccountinfos = accountinfoMapper.selectByExample(example);
        return tbAccountinfos;
    }
